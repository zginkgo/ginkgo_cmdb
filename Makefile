PROJECT_NAME := "ginkgo_cmdb"
MAIN_FILE_PAHT := "main.go"
PKG := "github.com/zginkgo/ginkgo_cmdb"
IMAGE_PREFIX := "github.com/zginkgo/ginkgo_cmdb"
...
gen: #d generate code
	...
	@#protoc -I=. --go_out=. --go-grpc_out=. --go_opt=module="github.com/zginkgo/ginkgo_cmdb" --go-grpc_opt=module="github.com/zginkgo/ginkgo_cmdb"  apps/*/pb/*
	...
	@protoc-go-inject-tag -input="apps/host/*.pb.go"
