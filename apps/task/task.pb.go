...
type CreateTaskRequst struct {
	...
	// 任务类型
	// @gotags: json:"type"
	Type Type `protobuf:"varint,1,opt,name=type,proto3,enum=ginkgo_cmdb.task.Type" json:"type"`
	// 测试运行
	// @gotags: json:"dry_run"
	...
	ResourceType resource.Type `protobuf:"varint,4,opt,name=resource_type,json=resourceType,proto3,enum=ginkgo_cmdb.resource.Type" json:"resource_type"`
	// 通知资源的Region
	// @gotags: json:"region"
...
type Status struct {
	...
	// 任务状态
	// @gotags: json:"stage"
	Stage Stage `protobuf:"varint,1,opt,name=stage,proto3,enum=ginkgo_cmdb.task.Stage" json:"stage"`
	// 失败时的异常信息
	// @gotags: json:"message"
...
type QueryTaskRequest struct {
	...
	// 更加资源类型来过滤任务
	// @gotags: json:"resource_type"
	ResourceType resource.Type `protobuf:"varint,3,opt,name=resource_type,json=resourceType,proto3,enum=ginkgo_cmdb.resource.Type" json:"resource_type"`
...
func (x *QueryTaskRequest) GetPage() *PageRequest {
	if x != nil {
		return x.Page
	}
	return nil
...
var file_apps_task_pb_task_proto_rawDesc = []byte{
	...
	0x61, 0x73, 0x6b, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x10, 0x67, 0x69, 0x6e, 0x6b, 0x67,
	0x6f, 0x5f, 0x63, 0x6d, 0x64, 0x62, 0x2e, 0x74, 0x61, 0x73, 0x6b, 0x1a, 0x1f, 0x61, 0x70, 0x70,
	0x73, 0x2f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2f, 0x70, 0x62, 0x2f, 0x72, 0x65,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x4d, 0x0a, 0x07,
	...
	0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x67,
	0x69, 0x6e, 0x6b, 0x67, 0x6f, 0x5f, 0x63, 0x6d, 0x64, 0x62, 0x2e, 0x74, 0x61, 0x73, 0x6b, 0x2e,
	...
	0x0b, 0x32, 0x22, 0x2e, 0x67, 0x69, 0x6e, 0x6b, 0x67, 0x6f, 0x5f, 0x63, 0x6d, 0x64, 0x62, 0x2e,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x67, 0x69,
	0x6e, 0x6b, 0x67, 0x6f, 0x5f, 0x63, 0x6d, 0x64, 0x62, 0x2e, 0x74, 0x61, 0x73, 0x6b, 0x2e, 0x53,
	...
	0x32, 0x16, 0x2e, 0x67, 0x69, 0x6e, 0x6b, 0x67, 0x6f, 0x5f, 0x63, 0x6d, 0x64, 0x62, 0x2e, 0x74,
	...
	0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x67, 0x69,
	...
	0x67, 0x69, 0x6e, 0x6b, 0x67, 0x6f, 0x5f, 0x63, 0x6d, 0x64, 0x62, 0x2e, 0x74, 0x61, 0x73, 0x6b,
	...
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x17, 0x2e, 0x67, 0x69, 0x6e, 0x6b, 0x67, 0x6f, 0x5f, 0x63, 0x6d,
	...
	0x61, 0x6c, 0x46, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x22, 0xa2, 0x01, 0x0a, 0x10, 0x51, 0x75, 0x65,
	0x72, 0x79, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x31, 0x0a,
	0x04, 0x70, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x67, 0x69,
	0x6e, 0x6b, 0x67, 0x6f, 0x5f, 0x63, 0x6d, 0x64, 0x62, 0x2e, 0x74, 0x61, 0x73, 0x6b, 0x2e, 0x50,
	...
	0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x67, 0x69, 0x6e, 0x6b, 0x67, 0x6f,
	0x5f, 0x63, 0x6d, 0x64, 0x62, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x54,
	...
	0x13, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x02, 0x69, 0x64, 0x22, 0x63, 0x0a, 0x0b, 0x50, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75,
	...
	0x03, 0x52, 0x06, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x2a, 0x2f, 0x0a, 0x04, 0x54, 0x79, 0x70,
	...
	,
	...
	0x67, 0x6f, 0x5f, 0x63, 0x6d, 0x64, 0x62, 0x2f, 0x61, 0x70, 0x70, 0x73, 0x2f, 0x74, 0x61, 0x73,
...
var file_apps_task_pb_task_proto_goTypes = []interface{}{
	(Type)(0),                   // 0: ginkgo_cmdb.task.Type
	(Stage)(0),                  // 1: ginkgo_cmdb.task.Stage
	(*TaskSet)(nil),             // 2: ginkgo_cmdb.task.TaskSet
	(*Task)(nil),                // 3: ginkgo_cmdb.task.Task
	(*CreateTaskRequst)(nil),    // 4: ginkgo_cmdb.task.CreateTaskRequst
	(*Status)(nil),              // 5: ginkgo_cmdb.task.Status
	(*QueryTaskRequest)(nil),    // 6: ginkgo_cmdb.task.QueryTaskRequest
	(*DescribeTaskRequest)(nil), // 7: ginkgo_cmdb.task.DescribeTaskRequest
	(*PageRequest)(nil),         // 8: ginkgo_cmdb.task.PageRequest
	nil,                         // 9: ginkgo_cmdb.task.CreateTaskRequst.ParamsEntry
	(resource.Type)(0),          // 10: ginkgo_cmdb.resource.Type
}
var file_apps_task_pb_task_proto_depIdxs = []int32{
	3,  // 0: ginkgo_cmdb.task.TaskSet.items:type_name -> ginkgo_cmdb.task.Task
	4,  // 1: ginkgo_cmdb.task.Task.data:type_name -> ginkgo_cmdb.task.CreateTaskRequst
	5,  // 2: ginkgo_cmdb.task.Task.status:type_name -> ginkgo_cmdb.task.Status
	0,  // 3: ginkgo_cmdb.task.CreateTaskRequst.type:type_name -> ginkgo_cmdb.task.Type
	10, // 4: ginkgo_cmdb.task.CreateTaskRequst.resource_type:type_name -> ginkgo_cmdb.resource.Type
	9,  // 5: ginkgo_cmdb.task.CreateTaskRequst.params:type_name -> ginkgo_cmdb.task.CreateTaskRequst.ParamsEntry
	1,  // 6: ginkgo_cmdb.task.Status.stage:type_name -> ginkgo_cmdb.task.Stage
	8,  // 7: ginkgo_cmdb.task.QueryTaskRequest.page:type_name -> ginkgo_cmdb.task.PageRequest
	10, // 8: ginkgo_cmdb.task.QueryTaskRequest.resource_type:type_name -> ginkgo_cmdb.resource.Type
	4,  // 9: ginkgo_cmdb.task.Service.CreateTask:input_type -> ginkgo_cmdb.task.CreateTaskRequst
	6,  // 10: ginkgo_cmdb.task.Service.QueryTask:input_type -> ginkgo_cmdb.task.QueryTaskRequest
	7,  // 11: ginkgo_cmdb.task.Service.DescribeTask:input_type -> ginkgo_cmdb.task.DescribeTaskRequest
	3,  // 12: ginkgo_cmdb.task.Service.CreateTask:output_type -> ginkgo_cmdb.task.Task
	2,  // 13: ginkgo_cmdb.task.Service.QueryTask:output_type -> ginkgo_cmdb.task.TaskSet
	3,  // 14: ginkgo_cmdb.task.Service.DescribeTask:output_type -> ginkgo_cmdb.task.Task
